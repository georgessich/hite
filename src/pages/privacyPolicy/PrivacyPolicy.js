...
const PrivacyPolicy = () => {
  return (
    <div style={{ display: "flex", flexDirection: "column", margin: "0 auto", width: "60%"}}>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Hite, 23, Park Street, Rostov-on-Don.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Hite, accessible from{" "}
            <a href="hite.io" rel="external nofollow noopener" target="_blank">
              hite.io
            </a>
          </p>
        </li>
